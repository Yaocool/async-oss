...
class Bucket(_Base):
    ...
    async def list_objects_v2(self, prefix='', delimiter='', continuation_token='', start_after='', fetch_owner=False,
                              encoding_type='url', max_keys=100, headers=None):
        """根据前缀罗列Bucket里的文件。
    ...
    async def put_object_with_url_from_file(self, sign_url, filename,
                                            headers=None,
                                            progress_callback=None):
        """ 使用加签的url上传本地文件到oss
    ...
    async def select_object_to_file(self, key, filename, sql,
                                    progress_callback=None,
                                    select_params=None,
                                    headers=None
                                    ):
        ...
        """
        with open(to_unicode(filename), 'wb') as f:
            result = await self.select_object(key, sql, progress_callback=progress_callback,
    ...
    async def put_bucket_acl(self, permission):
        ...
        resp = await self.__do_bucket('PUT', headers={OSS_CANNED_ACL: permission}, params={Bucket.ACL: ''})
    ...
    async def put_bucket_website(self, input):
        ...
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.WEBSITE: ''}, headers=headers)
    ...
    async def post_vod_playlist(self, channel_name, playlist_name, start_time=0, end_time=0):
        ...
        resp = await self.__do_object('POST', key, params={Bucket.VOD: '', 'startTime': str(start_time),
    ...
    async def get_vod_playlist(self, channel_name, start_time, end_time):
        ...
        resp = await self.__do_object('GET', channel_name, params={Bucket.VOD: '', 'startTime': str(start_time),
                                                                   'endTime': str(end_time)})
    ...
    async def process_object(self, key, process, headers=None):
        ...
        resp = await self.__do_object('POST', key, params={Bucket.PROCESS: ''}, headers=headers, data=process_data)
    ...
    async def put_bucket_encryption(self, rule):
        ...
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.ENCRYPTION: ""})
    ...
    async def get_bucket_encryption(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.ENCRYPTION: ''})
    ...
    async def delete_bucket_encryption(self):
        ...
        resp = await self.__do_bucket('DELETE', params={Bucket.ENCRYPTION: ''})
        logger.debug(
    ...
    async def put_bucket_tagging(self, tagging, headers=None):
        ...
        data = self.__convert_data(Tagging, xml_utils.to_put_tagging, tagging)
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.TAGGING: ''}, headers=headers)
    ...
    async def put_bucket_versioning(self, config, headers=None):
        ...
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.VERSIONING: ''}, headers=headers)
    ...
    async def get_bucket_versioning(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.VERSIONING: ''})
    ...
    async def put_bucket_policy(self, policy):
        ...
        resp = await self.__do_bucket('PUT', data=policy, params={Bucket.POLICY: ''},
    ...
    async def get_bucket_policy(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.POLICY: ''})
    ...
    async def delete_bucket_policy(self):
        ...
        resp = await self.__do_bucket('DELETE', params={Bucket.POLICY: ''})
    ...
    async def put_bucket_request_payment(self, payer):
        ...
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.REQUESTPAYMENT: ''},
                                      headers={'Content-MD5': utils.content_md5(data)})
        logger.debug(
    ...
    async def get_bucket_request_payment(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.REQUESTPAYMENT: ''})
        logger.debug(
            "Get bucket request payment done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))

        return await self._parse_result(resp, xml_utils.parse_get_bucket_request_payment, GetBucketRequestPaymentResult)
    ...
    async def put_bucket_qos_info(self, bucket_qos_info):
        ...
        headers = http.CaseInsensitiveDict()
        headers['Content-MD5'] = utils.content_md5(data)
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.QOS_INFO: ''}, headers=headers)
    ...
    async def get_bucket_qos_info(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.QOS_INFO: ''})
    ...
    async def delete_bucket_qos_info(self):
        ...
        resp = await self.__do_bucket('DELETE', params={Bucket.QOS_INFO: ''})
    ...
    async def set_bucket_storage_capacity(self, user_qos):
        ...
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.USER_QOS: ''})
        logger.debug(
            "Set bucket storage capacity done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))
    ...
    async def get_bucket_storage_capacity(self):
        ...
        resp = await self._Bucket__do_bucket('GET', params={Bucket.USER_QOS: ''})
        logger.debug(
            "Get bucket storage capacity done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))
    ...
    async def put_async_fetch_task(self, task_config):
        ...
        headers = http.CaseInsensitiveDict()
        headers['Content-MD5'] = utils.content_md5(data)
        resp = await self._Bucket__do_bucket('POST', data=data, params={Bucket.ASYNC_FETCH: ''}, headers=headers)
    ...
    async def get_async_fetch_task(self, task_id):
        ...
        resp = await self._Bucket__do_bucket('GET', headers={OSS_TASK_ID: task_id}, params={Bucket.ASYNC_FETCH: ''})
        logger.debug("Put async fetch task done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))
    ...
    async def put_bucket_inventory_configuration(self, inventory_configuration):
        ...
        data = self.__convert_data(InventoryConfiguration, xml_utils.to_put_inventory_configuration,
                                   inventory_configuration)

        headers = http.CaseInsensitiveDict()
        headers['Content-MD5'] = utils.content_md5(data)
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.INVENTORY: '',
                                                                Bucket.INVENTORY_CONFIG_ID: inventory_configuration.inventory_id},
                                      headers=headers)
        logger.debug("Put bucket inventory configuration done, req_id: {0}, status_code: {1}".format(resp.request_id,
                                                                                                     resp.status))
    ...
    async def get_bucket_inventory_configuration(self, inventory_id):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.INVENTORY: '', Bucket.INVENTORY_CONFIG_ID: inventory_id})
        logger.debug("Get bucket inventory cinfguration done, req_id: {0}, status_code: {1}".format(resp.request_id,
                                                                                                    resp.status))

        return await self._parse_result(resp, xml_utils.parse_get_bucket_inventory_configuration,
    ...
    async def list_bucket_inventory_configurations(self, continuation_token=None):
        ...
        logger.debug("List bucket inventory configuration done, req_id: {0}, status_code: {1}".format(resp.request_id,
                                                                                                      resp.status))

        return await self._parse_result(resp, xml_utils.parse_list_bucket_inventory_configurations,
    ...
    async def delete_bucket_inventory_configuration(self, inventory_id):
        ...
        :return: :class:`RequestResult <oss2.models.RequestResult>`
        """
        logger.debug("Start to delete bucket inventory configuration, bucket: {0}, configuration id: {1}.".format(
            self.bucket_name, inventory_id))
        resp = await self.__do_bucket('DELETE', params={Bucket.INVENTORY: '', Bucket.INVENTORY_CONFIG_ID: inventory_id})
        logger.debug(
            "Delete bucket inventory configuration, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))
    ...
    async def abort_bucket_worm(self):
        ...
        resp = await self.__do_bucket('DELETE', params={Bucket.WORM: ''})
    ...
    async def complete_bucket_worm(self, worm_id=None):
        ...
        resp = await self.__do_bucket('POST', params={Bucket.WORM_ID: worm_id})
    ...
    async def extend_bucket_worm(self, worm_id=None, retention_period_days=None):
        ...
        resp = await self.__do_bucket('POST', data=data, params={Bucket.WORM_ID: worm_id, Bucket.WORM_EXTEND: ''},
                                      headers=headers)
    ...
    async def get_bucket_worm(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.WORM: ''})
    ...
    async def get_bucket_replication(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.REPLICATION: ''})
        logger.debug("Get bucket replication done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))

        return await self._parse_result(resp, xml_utils.parse_get_bucket_replication_result, GetBucketReplicationResult)
    ...
    async def delete_bucket_replication(self, rule_id):
        ...
        headers = http.CaseInsensitiveDict()
        headers['Content-MD5'] = utils.content_md5(data)
        resp = await self.__do_bucket('POST', data=data, params={Bucket.REPLICATION: '', 'comp': 'delete'},
                                      headers=headers)
        logger.debug(
    ...
    async def get_bucket_replication_location(self):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.REPLICATION_LOCATION: ''})
        logger.debug(
            "Get bucket replication location done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))

        return await self._parse_result(resp, xml_utils.parse_get_bucket_replication_location_result,
    ...
    async def get_bucket_replication_progress(self, rule_id):
        ...
        resp = await self.__do_bucket('GET', params={Bucket.REPLICATION_PROGRESS: '', 'rule-id': rule_id})
        logger.debug(
            "Get bucket replication progress done, req_id: {0}, status_code: {1}".format(resp.request_id, resp.status))

        return await self._parse_result(resp, xml_utils.parse_get_bucket_replication_progress_result,
    ...
    async def put_bucket_transfer_acceleration(self, enabled):
        ...
        headers = http.CaseInsensitiveDict()
        headers['Content-MD5'] = utils.content_md5(data)
        resp = await self.__do_bucket('PUT', data=data, params={Bucket.TRANSFER_ACCELERATION: ''}, headers=headers)
        logger.debug(
