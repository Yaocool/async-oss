...
class ObjectIteratorV2(_BaseIterator):
    ...
    def __init__(self, bucket, prefix='', delimiter='', continuation_token='', start_after='', fetch_owner=False,
                 encoding_type='url', max_keys=100, max_retries=None, headers=None):
